...
function Profile({ showSuccessMessage = false }) {
    ...
    <>
      ...
      {showSuccessMessage && message && (
        <div className={styles.card} style={{ marginTop: "16px" }}>
          <div className={styles.header}>
            <h3 className={styles.title}>Owner Verification</h3>
            <p className={styles.subtitle}>Upload your government ID for account verification (one-time)</p>
          </div>
          <div className={styles.verifiedBox}>
            ...
            <p className={styles.verifiedSubtitle}>
              Your identity has been verified on {new Date().toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" })}
            </p>
          </div>
        </div>
      )}
