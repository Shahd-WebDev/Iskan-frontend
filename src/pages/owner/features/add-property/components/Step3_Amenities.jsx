  ...
  return (
    <>
      <div className={stepStyles["amenities-section"]}>
        ...
        {errors.amenities && (
          <span className={compStyles["error-text"]}>{errors.amenities}</span>
        )}
      </div>

      <div className={stepStyles["photos-section"]}>
        <label className={stepStyles["amenities-label"]}>
          Property Photos *
        </label>
        <div
        ...
        {errors.photos && (
          <span className={compStyles["error-text"]}>{errors.photos}</span>
        )}
          ...
          <div className={stepStyles["photos-preview"]}>
            {photos.map((photo, index) => (
              <div key={index} className={stepStyles["photo-thumbnail"]}>
                ...
                <div className={stepStyles["photo-overlay"]}>
                  <button
                    type="button"
                    className={`${stepStyles["main-photo-btn"]} ${mainPhotoIndex === index ? stepStyles["main-selected"] : ""}`}
                    onClick={(e) => {
                      e.stopPropagation();
                      selectMainPhoto(index);
                    }}
                  >
                    {mainPhotoIndex === index ? "Main photo" : "Set main"}
                  </button>
                </div>
                <button
                  type="button"
                  className={stepStyles["remove-photo"]}
                  onClick={(e) => {
                    e.stopPropagation();
                    removePhoto(index);
                  }}
